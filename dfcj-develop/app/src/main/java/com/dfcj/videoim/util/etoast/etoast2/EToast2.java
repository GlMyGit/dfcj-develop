package com.dfcj.videoim.util.etoast.etoast2;
...
import com.dfcj.videoim.util.etoast.permission.OpPermissionUtils;
...
public class EToast2 {
    ...
    private EToast2(Context context, CharSequence text, int HIDE_DELAY){
        ...
        if(oldToast == null){
            ...
            params.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;//设置显示的位置
            params.y = 400;
