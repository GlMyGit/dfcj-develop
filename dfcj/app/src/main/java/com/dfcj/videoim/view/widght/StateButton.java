...
public class StateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.StateButtonViews);
        ...
        mNormalTextColor = a.getColor(R.styleable.StateButtonViews_normal_TextColors, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.StateButtonViews_pressed_TextColors, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.StateButtonViews_unable_TextColors, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.StateButtonViews_s_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.StateButtonViews_normal_BackgroundColors, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.StateButtonViews_pressed_BackgroundColors, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.StateButtonViews_unable_BackgroundColors, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StateButtonViews_s_radius, 0);
        mRound = a.getBoolean(R.styleable.StateButtonViews_s_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.StateButtonViews_stroke_DashWidths, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.StateButtonViews_stroke_DashWidths, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButtonViews_normal_StrokeWidths, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButtonViews_pressed_StrokeWidths, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButtonViews_unable_StrokeWidths, 0);
        mNormalStrokeColor = a.getColor(R.styleable.StateButtonViews_normal_StrokeColors, 0);
        mPressedStrokeColor = a.getColor(R.styleable.StateButtonViews_pressed_StrokeColors, 0);
        mUnableStrokeColor = a.getColor(R.styleable.StateButtonViews_unable_StrokeColors, 0);
        setStroke();
