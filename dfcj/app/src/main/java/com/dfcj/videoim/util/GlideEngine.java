...
public class GlideEngine implements ImageEngine {
     ...
     * @return 图片文件路径   + "_" + imageType
     */
    public static String generateImagePath(Context conn,String uuid, int imageType) {
        return getImageDownloadDir(conn) + uuid;
    }

    public static String getImageDownloadDir(Context context) {

         String IMAGE_DOWNLOAD_DIR_SUFFIX = "/image/download/";

        String appDir =context.getFilesDir().getAbsolutePath();

        return appDir+ IMAGE_DOWNLOAD_DIR_SUFFIX;
    }
    ...
    public static void loadCornerImageWithoutPlaceHolder(Context context,ImageView imageView, String filePath, RequestListener listener, float radius) {
