...
public class BubbleProgressView extends View {
    ...
    private int mColorProgressStr = getResources().getColor(R.color.color_D9001C);//进度条的进度文字的颜色
    private int mColorProgressStr2 = getResources().getColor(R.color.color_FFE5DF);//进度条的进度文字的颜色
    private float mProgressHeight = 23;
    private float mProgress=0;//进度条的进度
    private float mBubbleTriangleHeight = 12;//气泡底部小三角高度
    private float mBubbleRectRound = AppUtils.px2dip(getContext(),30);//气泡的圆角
    private String mProgressStr = "还差0.00提现";//显示进度的字符串
    private float mTextSize = AppUtils.sp2px(getContext(),10);//进度条文字大小
    private Paint.FontMetricsInt mFontMetricsInt;
    private float mProgressStrMargin = AppUtils.px2dip(getContext(),30);//气泡的边距
    ...
    private void init() {
        ...
        mColorProgressBg = getResources().getColor(R.color.color_FFE5DF);
        mColorProgress = getResources().getColor(R.color.color_EB3B42);
        mPaintBubble.setColor(getResources().getColor(R.color.color_FFE5DF));//设置气泡的颜色
