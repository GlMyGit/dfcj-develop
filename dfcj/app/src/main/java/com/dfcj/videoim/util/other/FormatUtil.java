...
public class FormatUtil {
    ...
    public static String getUUID(Context context, boolean flag) {
        ...
        if(flag){
            ...
            deviceID = getAndroidUUid(context);
        }
    ...
    @SuppressLint("MissingPermission")
    public static String getImeiIdVal(Context context) {
        String tmDevice="";
    ...
    //获取android id
    public static String getAndroidUUid(Context con)
    {
    ...
    public static String getAndroidIdVal(Context con)
    {
        String androidId = Settings.Secure.getString(
                con.getContentResolver(),
                Settings.Secure.ANDROID_ID);
